                ...
                <div class="container-fluid">
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="pro-user-name ml-1">
                                    Ahmed Mohamed <i class="mdi mdi-chevron-down"></i> 
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                <!-- item-->
                                <div class="dropdown-header noti-title">
                                    <h6 class="text-overflow m-0">Admin user</h6>
                                </div>
                    ...
                    <div class="logo-box">
                        ...
                        <a href="index.html" class="logo logo-light text-center">
                            <span class="logo-sm">
                                <img src="../assets/images/cropLogo.png" alt="" height="40">
                            </span>
                            <span class="logo-lg">
                    ...
                    <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                        ...
                        <li class="dropdown d-none d-xl-block">
                            <a class="nav-link waves-effect waves-light lg-font" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                School Name
                            </a>
