                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box">
                                    ...
                                    <h2 class="text-success my-3 text-center"><span data-plugin="counterup">683</span></h2>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box">
                                    ...
                                    <h2 class="text-success my-3 text-center">$<span data-plugin="counterup">68,541</span></h2>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-3 chartjs-chart">
                                            <canvas id="revenue-chart" data-colors="#2892fd,#4fc6e1" height="300"></canvas>
                                        </div>
                                    </div> <!-- end card-body-->
                                </div> <!-- end card-->
                            </div> <!-- end col -->
